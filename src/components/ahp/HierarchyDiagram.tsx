...
export function HierarchyDiagram({ 
  ...
  return (
    <div className="mt-8 w-full overflow-hidden rounded-xl border bg-card/90 p-4 shadow-xl shadow-black/10 sm:p-8">
      <div className="flex items-center justify-between mb-10 border-b pb-4">
        ...
        <div className="flex gap-4 text-[10px] uppercase font-bold tracking-wider">
          ...
          <div className="flex items-center gap-1.5">
            <div className="h-3 w-3 rounded-sm border border-primary bg-card"></div>
            <span>Criteria</span>
          </div>
          <div className="flex items-center gap-1.5">
      ...
      <div ref={containerRef} className="relative flex flex-col items-center gap-24 py-4">
        ...
        <div className="relative z-10">
          <div ref={goalRef} className="min-w-[200px] rounded-xl border-2 border-primary/40 bg-primary px-8 py-4 text-center font-bold text-primary-foreground shadow-lg shadow-primary/10">
          ...
          {criteria.map((c, i) => (
            <div key={i} className="flex flex-col items-center">
              <div 
                ...
                className="group w-full max-w-[160px] rounded-lg border-2 border-primary/30 bg-card/95 px-4 py-3 text-center shadow-sm backdrop-blur-sm transition-colors hover:border-primary"
              >
            ...
            return (
              <div key={i} className="flex flex-col items-center">
                <div 
                  ...
                  className={`
                    ${(isWinner && showWeights) ? 'bg-accent text-accent-foreground shadow-accent/20 border-accent' : 'bg-card text-foreground border-border'}
                ...
                >
                  ...
                  {showWeights && (
                    <div className={`
                      ...
                      ${isWinner ? 'bg-background/20 text-accent-foreground' : 'bg-secondary text-muted-foreground'}
                    `}>
